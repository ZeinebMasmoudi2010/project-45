...
function setup(){
    ...
    greyheart1=createSprite(50,50)
    greyheart1.addImage(greyheartImg)
    greyheart1.scale=0.2

    greyheart2=createSprite(120,50)
    greyheart2.addImage(greyheartImg)
    greyheart2.scale=0.2

    greyheart3=createSprite(190,50)
    greyheart3.addImage(greyheartImg)
    greyheart3.scale=0.2
    ...
    if(gamestate===0){
        ...
        greyheart1.visible=false
        greyheart2.visible=false
        greyheart3.visible=false
        donut.visible=false
        homer.visible=false
        lisa.visible=false
        marge.visible=false
    ...
    if(gamestate===1){
        ...
        //pinkheartGroup.add(pinkheart1)
        //pinkheartGroup.add(pinkheart2)
        //pinkheartGroup.add(pinkheart3)

        //greyheartGroup.add(greyheart1)
        //greyheartGroup.add(greyheart2)
        //greyheartGroup.add(greyheart3)
        
        if(homer.collide(wallGroup)){
            homer.velocityX=Math.round(random(-4,4))
            homer.velocityY=Math.round(random(-4,4))
        }
        if(lisa.collide(wallGroup)){
            lisa.velocityX=Math.round(random(-4,4))
            lisa.velocityY=Math.round(random(-4,4))
        }
        if(maggie.collide(wallGroup)){
            maggie.velocityX=Math.round(random(-4,4))
            maggie.velocityY=Math.round(random(-4,4))
        }
        if(marge.collide(wallGroup)){
            marge.velocityX=Math.round(random(-4,4))
            marge.velocityY=Math.round(random(-4,4))
        }
        ...
        if(marge.velocityX===0&&marge.velocityY===0){
          ...
          if(donut.collide(homer)||donut.collide(lisa)||donut.collide(maggie)||donut.collide(marge)){
